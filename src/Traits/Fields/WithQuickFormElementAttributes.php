...
trait WithQuickFormElementAttributes
{
    ...
    {
        $this->setAttribute('required', Condition::boolean($condition, true));
    ...
    {
        $this->setAttribute('disabled', Condition::boolean($condition, true));
    ...
    {
        $this->setAttribute('readonly', Condition::boolean($condition, true));
