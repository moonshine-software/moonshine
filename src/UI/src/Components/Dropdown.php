...
/**
 * @method static static make(?string $title = null, Closure|string $toggler = '', Closure|Renderable|string $content = '', (Closure(self): string[])|string[] $items = [], bool $searchable = false, Closure|string $searchPlaceholder = '', string $placement = 'bottom-start', Closure|string $footer = '')
 */
final class Dropdown extends MoonShineComponent
{
    ...
    protected function viewData(): array
    {
        return [
            ...
            'slot' => new ComponentSlot($this->stringifySlotContent(value($this->content, $this))),
