...
class MinimalLayout extends AppLayout
{
    ...
    protected function colors(ColorManagerContract $colorManager): void
    {
        $colorManager
            ...
            ->theme('0.2596 0.0663 279.52', 'default')
            ->theme('0.9846 0.0017 247.84', 50)
            ->theme('0.967 0.0029 264.54', 100)
            ->theme('0.9276 0.0058 264.53', 200)
            ->theme('0.8717 0.0093 258.34', 300)
            ->theme('0.7137 0.0192 261.32', 400)
            ->theme('0.551 0.0234 264.36', 500)
            ->theme('0.4461 0.0263 256.8', 600)
            ->theme('0.3729 0.0306 259.73', 700)
            ->theme('0.2781 0.0296 256.85', 800)
            ->theme('0.2101 0.0318 264.66', 900)
        ...
        $colorManager
            ...
            ->theme('0.5091 0.0523 257.61', 50, dark: true)
            ->theme('0.4671 0.0545 263.27', 100, dark: true)
            ->theme('0.4358 0.0585 264.2', 200, dark: true)
            ->theme('0.3926 0.0616 264.47', 300, dark: true)
            ->theme('0.3638 0.0582 266.67', 400, dark: true)
            ->theme('0.3324 0.0541 266.37', 500, dark: true)
            ->theme('0.3242 0.0506 266.68', 600, dark: true)
            ->theme('0.303 0.0443 272.77', 700, dark: true)
            ->theme('0.2665 0.0437 264.94', 800, dark: true)
            ->theme('0.2077 0.0398 265.75', 900, dark: true)
