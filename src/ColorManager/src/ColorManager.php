...
final class ColorManager implements ColorManagerContract
{
    ...
    public const DEFAULT = [
        // 'primary'      => '0.5759 0.21 293.86',
        // 'secondary'    => '0.6921 0.15 244.87',
        'primary' => '0.5118 0.2486 274.32',
        'secondary' => '0.5118 0.1944 307.06',
        'body' => '0.96 0 0',
        'theme-bg' => '1 0 0',
        'dark' => [
            'DEFAULT' => '0.26 0.066 279.517',
            50 => '0.509 0.052 257.609',
            100 => '0.467 0.054 263.268',
            200 => '0.436 0.059 264.202',
            300 => '0.393 0.062 264.473',
            400 => '0.364 0.058 266.668',
            500 => '0.332 0.054 266.369',
            600 => '0.324 0.051 266.679',
            700 => '0.303 0.044 272.77',
            800 => '0.264 0.04 268.672',
            900 => '0.208 0.04 265.755',
        ],
    ...
    public const DARK = [
        ...
        'theme-bg' => '0.2463 0.0168 274.32',
        'primary' => '0.90 0.5 264.05',
        'secondary' => '0.5118 0.1944 307.06',
        'success-bg' => '0.639 0.218 142.495',
