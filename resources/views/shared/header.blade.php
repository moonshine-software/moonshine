<header class="flex justify-between items-center py-4 px-6">
    ...
    <div class="flex items-center">
        <button x-show="!darkMode" x-on:click="darkMode=true" class="relative w-10 h-10 focus:outline-none focus:shadow-outline">
            <svg class="h-6 w-6" viewBox="0 0 24 24">
                <path fill="currentColor" d="M12 2A10 10 0 0 0 2 12A10 10 0 0 0 12 22A10 10 0 0 0 22 12A10 10 0 0 0 12 2M12 4A8 8 0 0 1 20 12A8 8 0 0 1 12 20V4Z"></path>
            </svg>
        </button>

        <button x-show="darkMode" x-on:click="darkMode=false" class="relative w-10 h-10 focus:outline-none focus:shadow-outline">
            <svg class="h-6 w-6" viewBox="0 0 24 24">
