        ...
        <div class="max-w-md w-full">
            <div>
                @if(config("moonshine.logo"))
                    <img class="mx-auto h-12 w-auto" src="{{ config("moonshine.logo") }}"
                         alt="{{ config("moonshine.title") }}">
                @else
                    <svg class="fill-current mx-auto h-12 w-auto my-4 text-pink" viewBox="0 0 1719.62 350.71"
                         xmlns="http://www.w3.org/2000/svg">
                        <circle cx="253.58" cy="100.75" r="27.62"
                                transform="matrix(.16022575 -.9870804 .9870804 .16022575 -14.01 334.92)"/>
                        ...
                        <g transform="translate(-127.52)">
                            <path
                                d="m345.86 272.53a16.3 16.3 0 1 1 -30.81-10.53 186.27 186.27 0 0 1 -93.05-91.44 12.3 12.3 0 0 1 -8.88-22.95 185.46 185.46 0 0 1 -8.39-55.32 187.57 187.57 0 0 1 1.84-26.23 138.09 138.09 0 1 0 177.28 211.72 185 185 0 0 1 -37.99-5.25zm-105.2-28a8 8 0 1 1 8-8 8 8 0 0 1 -8 8.03z"/>
                            <path
                            ...
                            <path
                                d="m851.75 152.17c36.9 0 57.42 21.09 57.42 63.82 0 42.55-20.33 63.26-57.42 63.26h-17.32c-37.09 0-57.43-20.71-57.43-63.25 0-42.74 20.52-63.82 57.42-63.82zm-17.32 22.22c-24.48 0-35.21 12.43-35.21 41.61 0 29 10.54 41 35.21 41h17.32c24.48 0 35-12.05 35-41.23 0-29-10.54-41.42-35-41.42z"/>
                            <path
                                d="m1005.38 152.17c36.9 0 57.42 21.09 57.42 63.82 0 42.55-20.33 63.26-57.42 63.26h-17.32c-37.09 0-57.42-20.71-57.42-63.26 0-42.74 20.52-63.82 57.42-63.82zm-17.32 22.22c-24.48 0-35.21 12.43-35.21 41.61 0 29 10.54 41 35.21 41h17.32c24.48 0 35-12.05 35-41.23 0-29-10.54-41.42-35-41.42z"/>
                            <path
                                d="m1111 279.26h-22.22v-101.67c0-16.57 9.41-27.68 29.18-27.68 17.7 0 25.6 9 30.88 23.53l37.09 81.14c1.51 3 4 5.27 8.1 5.27 4.71 0 7.53-2.82 7.53-7.15v-100.53h22.44v101.48c0 16.76-9.6 27.86-29.18 27.86-17.7 0-25.79-9-31.06-23.53l-37.09-81.14c-1.69-3.77-4-5.46-7.91-5.46-5.08 0-7.72 2.82-7.72 7.34z"/>
                            <path
                                d="m1352.55 152.17v22.22h-65.14c-11.48 0-16.57 6.21-16.57 15.06 0 7.72 4 15.06 18.83 15.06h29.75c34.64 0 42.74 19.2 42.74 37.47 0 21.46-11.48 37.28-40.48 37.28h-70.79v-22.26h71.54c12 0 17.51-6.59 17.51-15.81 0-8.28-4.33-15.81-20-15.81h-29.56c-33.89 0-41.8-19-41.8-36.71 0-21.09 11.3-36.52 39.54-36.52h64.39z"/>
            ...
            <form class="mt-8" action="{{ route(config('moonshine.route.prefix') . '.authenticate') }}" method="POST">
                ...
                <div class="rounded-md shadow-sm">
                    <div>
                        <input value="{{ old("email") }}" aria-label="{{ trans('moonshine::ui.login.email') }}"
                    ...
                    <div class="-mt-px">
                        <input aria-label="{{ trans('moonshine::ui.login.password') }}" name="password" type="password"
                               required
                ...
                <div class="mt-6 flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <input id="remember_me" name="remember" value="1" type="checkbox"
                               class="form-checkbox h-4 w-4 text-pink transition duration-150 ease-in-out">
